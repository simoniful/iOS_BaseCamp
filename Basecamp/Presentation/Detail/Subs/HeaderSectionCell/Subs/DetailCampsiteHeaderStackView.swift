...
final class DetailCampsiteHeaderStackView: UIStackView {
  ...
  private lazy var posblFcltyClStack = makeStack(first: posblFcltyClCategoryLabel, second: posblFcltyClContentLabel, axis: .vertical)
  ...
  func setupView() {
    ...
    [telStack, lctClFacltDivNmStack, indutyStack, campsiteOperHStack, homepageStack, posblFcltyClStack, resveClStack].forEach {
  ...
  func setData(data: DetailCampsiteHeaderItem) {
    ...
    posblFcltyClContentLabel.text = data.posblFcltyCl.isEmpty ? "문의요망" : data.posblFcltyCl.replacingOccurrences(of: ",", with: "・")
